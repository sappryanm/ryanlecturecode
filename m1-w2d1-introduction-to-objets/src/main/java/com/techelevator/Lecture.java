...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		System.out.println(javaString.charAt(0));
		...
		String base10 = Integer.toString(theAnswer, 10);
		String base2 = Integer.toString(theAnswer, 2);
		String base16 = Integer.toString(theAnswer, 16);
